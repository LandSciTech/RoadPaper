...
if(!file.exists(here::here("analysis/data/derived_data/ilcp_Rprof.out"))){
  source(here::here("analysis/scripts/test_profile.R"), keep.source = TRUE)
}

profstat(here::here("analysis/data/derived_data/ilcp_Rprof.out"))
...
profstat(here::here("analysis/data/derived_data/mst_Rprof.out"))
```
