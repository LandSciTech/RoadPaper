...
To demonstrate simple coupling of the roads R package with a spatial stochastic forest change projection model we created a road network to connect the harvest blocks in Daniel et al's [-@daniel_incorporating_2017] [SyncroSim](https://syncrosim.com/) state-and-transition simulation model for the Caribou Forest Management Unit in the boreal forest region of the province of Ontario, Canada. We used the [rsyncrosim](https://cran.r-project.org/web/packages/rsyncrosim/index.html) package to extract harvest information from the SyncroSim model [@daniel2025]. We provide code for this example in the ["8_integrate_roads_stsim_model.R"](https://github.com/LandSciTech/RoadPaper/blob/master/analysis/scripts/8_integrate_roads_stsim_model.R) script of our manuscript GitHub repository. An updated version of the Caribou Forest SyncroSim library published by Daniel et al. [-@daniel_incorporating_2017] is required for use with the current version of SyncroSim, and is available in our [OSF repository](https://osf.io/8vmqh/?view_only=d168967961914f22af89e44c19aec019).
