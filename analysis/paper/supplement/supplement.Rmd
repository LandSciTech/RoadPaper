...
```{r integrating, fig.height=3, fig.width=fig_widths["single"], fig.cap= "Projected roads for the Caribou Forest Management Unit. The figures below show the harvest blocks for the current timestep in dark grey and the cumulative roads built in the simulation in red.", fig.show='hold', out.width="450px", fig.align='center'}
knitr::include_graphics(here("analysis/figures/stsim_roads_tg_12545.it1.ts1.png"))
knitr::include_graphics(here("analysis/figures/stsim_roads_tg_12545.it1.ts5.png"))
knitr::include_graphics(here("analysis/figures/stsim_roads_tg_12545.it1.ts10.png"))
```
