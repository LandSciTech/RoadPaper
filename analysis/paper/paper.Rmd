...
- as expected, not great at projecting exact road locations. sources of discrepancy include switchback, stream crossings, inaccurate harvest locations. Missing switchbacks and too many stream crossings also reduce our total amount of roads. stream crossing behaviour could improved with more detailed high resolution cost. harvest and landing data. 
