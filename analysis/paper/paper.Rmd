...
To spatially define the cost of building and traveling on a forestry road we developed a simple cost raster based on the slope and major barriers. Following the Interior Appraisal Manual of BC, the base cost per kilometer of road was a linear function of slope [@governmentofbritishcolumbia2021a]. Major water bodies were considered barriers and assigned a very high cost. Lastly, existing roads were assigned a cost of 0 (Table 1). The cost raster produced consists of 1703936 pixels with a resolution of 100 meters by 100 meters.
