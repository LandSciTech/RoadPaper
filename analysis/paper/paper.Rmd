...
```{r study-area1, fig.cap="Road construction costs according to a simple model informed by slope and major barriers (Table 1) in the Revelstoke timber supply area in British Colombia, Canada."}
...
```{r study-area, fig.cap="Road construction costs according to a simple model informed by slope and major barriers (Table 1) in the Revelstoke timber supply area in British Colombia, Canada."}
