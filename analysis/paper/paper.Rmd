...
Difference maps highlight several potential causes of discrepancy between our projections and the observed road network. In most areas the projections remained within a reasonable vicinity of the observed roads and also realistically remained within valley bottoms without cutting across natural barriers such as mountains (Figure \@ref(fig:proj-map-fig)a). However, the cost raster is not sufficiently detailed to reflect costs of crossing rivers, streams or other wet areas in valley bottoms so the projections cross valleys more than the observed roads which often run parallel to one another on either side of valleys. There were also instances where cutblocks included in the data set appear to be misidentified and are not accessed by the observed road network (Figure \@ref(fig:proj-map-fig)b). In addition, the projected roads were not able to match the switchback pattern of observed roads in steep terrain (Figure \@ref(fig:proj-map-fig)c). All these discrepancies could be addressed with more accurate harvest and cost information.

<!--# TODO: I don't know that the switchback issue could be addressed with more accurate cost information. Wouldn't you need to account for the direction of the slope and cost according to that in order to induce that behaviour? I guess that would be better cost info but is more complicated than this implies.  -->
