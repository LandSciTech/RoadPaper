...
mp <- tm_shape(dist_dif)+
  tm_raster(palette = "BrBG", breaks = c(-2000, -1000, 1000, 2000), 
  ...
  tm_add_legend(type = "line", col = c("black", "#ca0020", "#0571b0"), 
